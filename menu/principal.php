        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div id="x3" class="sidebar-sticky">
            <ul class="nav flex-column">
			  ...
			  <li class="nav-itemP dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="mnu_Bancos" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				  <span data-feather="book"></span>
				  Bancos
				</a>
					<div class="dropdown-menu">

					  <a class="dropdown-item nav-link menu_pqn" id="mnu_crear_bancos" 	href="javascript:enviar_pagina('mnu_crear_bancos','issg_Bancos.php')">
					  <i class="fa fa-address-book-o" aria-hidden="true"></i></span>
					  Crear Banco				  
					  </a>

					  
					  <a class="dropdown-item nav-link menu_pqn" id="mnu_cuentas_bancarias" 	href="javascript:enviar_pagina('mnu_cuentas_bancarias','issg_cuentas_bancarias.php')">
					  <i class="fa fa-address-book-o" aria-hidden="true"></i></span>
					  Cuentas bancarias					  
					  </a>
		
					  <a class="dropdown-item nav-link menu_pqn" id="mnu_instrumentos_pagos" 	href="javascript:enviar_pagina('mnu_instrumentos_pagos','issg_instrumentos_pagos.php')">
					  <i class="fa fa-tasks" aria-hidden="true"></i>
					  Instrumentos Pagos
					  </a>
			  ...
			  <li class="nav-itemP dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="mnu_Retenciones" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				  <span data-feather="book"></span>
				  Retenciones
				</a>
					<div class="dropdown-menu">

					  <a class="dropdown-item nav-link menu_pqn" id="mnu_crear_operaciones" 	href="javascript:enviar_pagina('mnu_crear_operaciones','issg_operaciones.php')">
					  <i class="fa fa-address-book-o" aria-hidden="true"></i></span>
					  Crear Operaciones				  
					  </a>

					  
					  <a class="dropdown-item nav-link menu_pqn" id="mnu_crear_tipos_reten" 	href="javascript:enviar_pagina('mnu_crear_tipos_reten','issg_retenciones.php')">
					  <i class="fa fa-address-book-o" aria-hidden="true"></i></span>
					  Crear tipos retenciones					  
					  </a>
