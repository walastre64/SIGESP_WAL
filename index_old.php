...
$(document).ready(function(){
	...
	$("#btn_registrar").click(function(){	
		...
		//alert(resultado[0]);
			...
			"showDuration": "50","hideDuration": "500","timeOut": "2000","extendedTimeOut": "1000","preventDuplicates": true,"onclick": null,"progressBar": true,"positionClass": "toast-bottom-full-width"});
			setTimeout(function(){ limpiar_registrar(); window.location.href = "index.php"}, 5000);
			}else if(resultado[0] == 2) {

			    toastr.error('Este Correo ya esta registrado !!!', "Error !!!", {
				"showDuration": "50","hideDuration": "500","timeOut": "2000","extendedTimeOut": "1000","preventDuplicates": true,"onclick": null,"progressBar": true,"positionClass": "toast-bottom-full-width"});	
			    $("#txt_email").focus();
				setTimeout(function(){ $('#div_carga').hide();}, 2000);
				return false;			
							...
							<br>	
								<form method="POST"  name="login-form" class="form-horizontal" id="login-form">									
								  ...
								  <div class="form-group input-control" data-role="input" >
									...
									<hr class="form-group input-control"  color="#333333" width="500px">						
									<br>
								...
								<div align="center" id="div_registrar">
									...
									<form id="register-form" action="" method="post" role="form" >
										...
										<div id="div_juntoR" class="row">
											<div id="div_col">
												<div id="div_junto" class="form-group col-xs-12 col-md-10">
													<div  class="input-group">
														<input name="txt_nombreR"   type="text"   id="txt_nombreR"   class="form-control"  	tabindex="10" placeholder="Nombres" 	 onFocus="this.style.backgroundColor='#DDFEDA'" onBlur="this.style.backgroundColor='white'" value="" >				
														<input name="txt_apellidoR" type="text"   id="txt_apellidoR" class="form-control"  	tabindex="11" placeholder="Apellidos" onFocus="this.style.backgroundColor='#DDFEDA'" onBlur="this.style.backgroundColor='white'" value="" >
													</div>
												</div>
											</div>
										</div>
										...
										<div align="center"  class="form-group col-md-8" >
											<input type="email" class="input-group" 	name="email" 			id="txt_email"		  tabindex="12"  placeholder="Direccion Email" 		onFocus="this.style.backgroundColor='#DDFEDA'" onBlur="this.style.backgroundColor='white'" value="" >
										</div>
										<div align="center"  class="form-group col-md-8">
											<input type="password" class="input-group" 	name="txt_passwordR" 		id="txt_passwordR"	  tabindex="13"  placeholder="Password" 				onFocus="this.style.backgroundColor='#DDFEDA'" onBlur="this.style.backgroundColor='white'" >
										</div>
										<div align="center"  class="form-group col-md-8">
											<input type="password" class="input-group" 	name="txt_confirmar"    id="txt_confirmar" 	  tabindex="14"  placeholder="Confirmar Password" 	onFocus="this.style.backgroundColor='#DDFEDA'" onBlur="this.style.backgroundColor='white'" >
										</div>
										<div class="form-group">
											<div class="row">
												<div class="mx-auto" style="width:300px;">
													<input type="button" style="width:200px" name="btn_registrar" id="btn_registrar" tabindex="15" class="form-control btn btn-outline-success" value="Registrarse">
												</div>
											</div>
										</div>
									</form>					
