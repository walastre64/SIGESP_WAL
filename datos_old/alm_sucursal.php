...
$txt_id_sucu			= sanear_string($_POST['txt_id_sucu']);
$txt_nombre_sucu		= sanear_string($_POST['txt_nombre_sucu']);
$txt_direccion_sucu		= sanear_string($_POST['txt_direccion_sucu']);
$txt_codigo_interno		= sanear_string($_POST['txt_codigo_interno']);
$txt_status				= sanear_string($_POST['txt_status']);

$valor_consulta = 0;

$qry  =  "SET ANSI_NULLS ON SET ANSI_WARNINGS ON EXEC SP_ALM_SUCURSAL ";
$qry .=    "".$txt_id_sucu."";
$qry .=  ",'".$txt_nombre_sucu."'";
$qry .=  ",'".$txt_direccion_sucu."'";
